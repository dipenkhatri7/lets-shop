...
/**
 * Component for the Cart Screen of the application.
 * Displays the products added to the cart along with their details.
 * Users can update the quantity of products or remove them from the cart.
 * @returns {JSX.Element} - Cart Screen component.
 */
function CartScreen() {
  const { cart, updateQuantity, removeFromCart } = useCart();

  // Calculate total amount by multiplying price and quantity for each product in the cart
  ...
  return (
    <View className="flex-1 p-4 bg-white">
      ...
      {/* Render total amount and checkout button */}
...
/**
 * Component for rendering each item in the cart.
 * @param {object} props - Component props containing product details and functions for updating quantity and removing from cart.
